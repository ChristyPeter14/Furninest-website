...
router.post("/updateQuantity/:newQuantity/:index",userAuth,productController.updateQuantity)
...
router.post('/createProductReview',userAuth,orderController.createProductReview)
...
router.get('/deleteFromWishlist',userAuth,wishlistController.deleteFromWishlist)
